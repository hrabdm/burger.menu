...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form action="?page=add" method="POST">
            ...
            <br>
            <label>Email: <input class="form-control form-control-lg" type="text" name="email"></label><br>
            <label>Userphone: <input class="form-control form-control-lg" type="text" name="userphone"></label><br>
